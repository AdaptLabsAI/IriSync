      ...
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center bg-gray-50">
        <div className="max-w-sm mx-auto">
          ...
          <div className="mt-6">
            <Link
              href="/features"
              className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#00FF6A] hover:bg-[#00CC44] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00FF6A]"
            >
              View Plans
            </Link>
          </div>
