...
const API_GUIDES = [
  {
    ...
    path: '/documentation/category/api-guides/authentication',
  ...
  },
  {
    ...
    path: '/documentation/category/api-guides/endpoints',
  ...
  },
  {
    ...
    path: '/documentation/category/api-guides/integration',
  ...
  },
  {
    ...
    path: '/documentation/category/api-guides/webhooks',
  ...
  },
  {
    ...
    path: '/documentation/category/api-guides/content-api',
  ...
  },
  {
    ...
    path: '/documentation/category/api-guides/analytics-api',
  ...
  },
  {
    ...
    path: '/documentation/category/api-guides/user-management',
  ...
  },
  {
    ...
    path: '/documentation/category/api-guides/extensions',
    ...
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Grid container spacing={3}>
        {filteredGuides.map((guide) => (
          <Grid item={true} xs={12} sm={6} md={4} key={guide.id}>
            <Card 
              sx={{ 
                height: '100%', 
                display: 'flex', 
        ...
        <List>
          <ListItem>
            ...
            <ListItemText 
              ...
              secondary="Comprehensive reference for all endpoints" 
            />
            <Button 
              variant="outlined" 
              size="small" 
          ...
          <ListItem>
            ...
            <ListItemText 
              primary="Developer Community" 
              secondary="Connect with other developers using the IriSync API" 
            />
            <Button 
              variant="outlined" 
              size="small" 
          ...
          <ListItem>
            ...
            <ListItemText 
              primary="Examples & SDKs" 
              secondary="Code examples and libraries for popular languages" 
            />
            <Button 
              variant="outlined" 
              size="small" 
...
export default function WrappedApiGuidesPage() {
  return (
    <MainLayout>
      <ApiGuidesPage />
    </MainLayout>
