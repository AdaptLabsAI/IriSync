...
import { BsWhatsapp, BsTelegram, BsInstagram, BsTwitterX, BsLinkedin } from 'react-icons/bs';
...
export default function ProfilePage() {
  ...
  const getSocialIcon = (icon: string) => {
    ...
    switch (icon) {
      ...
      default:
        return <svg {...iconProps} fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
            <div className="h-40 bg-gradient-to-r from-blue-500 to-purple-600 relative">
              <div className="absolute -bottom-12 left-6">
                <div className="w-24 h-24 bg-[#F5F5F7] rounded-full p-3">
                ...
                <div key={index} className="flex items-center justify-between pb-4 border-b border-gray-100 last:border-0">
                  ...
                  <button 
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                      account.connected
                        ? "bg-gray-100 text-[#131A13] border border-gray-200 hover:bg-gray-200"
                        : "bg-green-50 text-[#00C853] border border-green-200 hover:bg-green-100"
                    }`}
                  >
