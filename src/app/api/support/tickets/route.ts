...
import { withAuth, withAdmin } from '@/lib/auth/route-handlers';
import { z } from 'zod';
...
import { sendTicketCreatedEmail, sendTicketUpdatedEmail, sendTicketClosedEmail } from '@/lib/notifications/email';
import { notifySlack, notifyCRM, notifyEmail } from '@/lib/notifications/integrations';
...
import { Ticket, convertFirestoreTicket } from '@/lib/support/models';
