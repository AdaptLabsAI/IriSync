...
import { testEmailSetup, validateSendGridKey } from '@/lib/notifications/test-email';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { default: unifiedEmailService } = await import('@/lib/notifications/unified-email-service');
